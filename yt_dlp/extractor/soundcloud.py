    ...
    def _extract_set(self, playlist, token=None):
        ...
        for idx, track in enumerate(tracks, start=1):
            ...
            entries.append(self.url_result(
                url, SoundcloudIE.ie_key(), track_id, url_transparent=True, **album_info, track_number=idx))
...
class SoundcloudSetIE(SoundcloudPlaylistBaseIE):
    ...
    _TESTS = [{
        # No release date, no tags, some tracks DRM protected
        ...
        'playlist': [
            {
                'info_dict': {
                    ...
                    'track_number': 1,
                    'album_artists': ['Levi Ryan'],
                    'description': 'md5:693d4673a833e632850f966a94c78ac9',
                    'uploader': 'Levi Ryan',
                    'uploader_id': '229146182',
                    'uploader_url': 'https://soundcloud.com/leviryan',
                    'comment_count': int,
                    ...
                    'repost_count': int,
                    'duration': 207.614,
                    'thumbnail': 'https://i1.sndcdn.com/artworks-2hmuDCrcvCzzCaXZ-1rztZA-original.jpg',
                    'tags': ['Ambient'],
                    'artists': ['Levi Ryan'],
                    'genres': ['Hip-hop & Rap'],
            ...
            },
            {
                'info_dict': {
                    ...
                    'track_number': 2,
                    'album_artists': ['Levi Ryan'],
                    'description': 'md5:baa25d5586c79b233f02dc7feb4c8440',
                    'uploader': 'Levi Ryan',
                    'uploader_id': '229146182',
                    'uploader_url': 'https://soundcloud.com/leviryan',
                    'comment_count': int,
            ...
            },
            {
                'info_dict': {
                    'ext': 'm4a',
                    'title': 'silkroad w/LONEWOLFPRIE',
                    'id': '1378981744',
                    'album': 'out of spite',
                    'album_type': 'album',
                    'track_number': 3,
                    'album_artists': ['Levi Ryan'],
                    'description': 'md5:9154b463cdcd164b6d488c710a976707',
                    'uploader': 'Levi Ryan',
                    'uploader_id': '229146182',
                    'uploader_url': 'https://soundcloud.com/leviryan',
                    'comment_count': int,
                    ...
                    'artists': ['Levi Ryan'],
                    'genres': ['Hip-hop & Rap'],
                    'track': 'silkroad w/LONEWOLFPRIE',
                    'timestamp': 1667935283,
                    'upload_date': '20221108',
                    'modified_timestamp': 1667935759,
                    'modified_date': '20221108',
                    'license': 'all-rights-reserved',
                },
            },
            {
                'info_dict': {
                    ...
                    'track_number': 4,
                    'album_artists': ['Levi Ryan'],
                    'description': 'md5:6f40a89b43f69a962a634447fabb7df5',
                    'uploader': 'Levi Ryan',
                    'uploader_id': '229146182',
                    'uploader_url': 'https://soundcloud.com/leviryan',
                    'comment_count': int,
                    ...
                    'genres': ['Dance & EDM'],
                    'track': 'purextc',
                    'timestamp': 1667935068,
                    'upload_date': '20221108',
                    'modified_timestamp': 1667959275,
                    'modified_date': '20221109',
                    'license': 'all-rights-reserved',
                },
            },
            {
                'info_dict': {
                    'ext': 'm4a',
                    'title': 'bright eyes w/funeral',
                    'id': '1378978405',
                    'album': 'out of spite',
                    'album_type': 'album',
                    'track_number': 5,
                    'album_artists': ['Levi Ryan'],
                    'description': 'md5:64eec6b3b8611db2ab695109b9899e6d',
                    'uploader': 'Levi Ryan',
                    'uploader_id': '229146182',
                    'uploader_url': 'https://soundcloud.com/leviryan',
                    'comment_count': int,
                    ...
                    'artists': ['Levi Ryan'],
                    'genres': ['Hip-hop & Rap'],
                    'track': 'bright eyes w/funeral',
                    'timestamp': 1667934876,
                    'upload_date': '20221108',
                    'modified_timestamp': 1708543327,
                    'modified_date': '20240221',
                    'license': 'all-rights-reserved',
                },
            },
            {
                'info_dict': {
                    'ext': 'm4a',
                    'title': 'misery w/lor2mg',
                    'id': '1378976746',
                    'album': 'out of spite',
                    'album_type': 'album',
                    'track_number': 6,
                    'album_artists': ['Levi Ryan'],
                    'description': 'md5:001ad79fc818c4c8e815070a714b730b',
                    'uploader': 'Levi Ryan',
                    'uploader_id': '229146182',
                    'uploader_url': 'https://soundcloud.com/leviryan',
                    'comment_count': int,
                    ...
                    'artists': ['Levi Ryan'],
                    'genres': ['Dance & EDM'],
                    'track': 'misery w/lor2mg',
                    'timestamp': 1667934686,
                    'upload_date': '20221108',
                    'modified_timestamp': 1667959374,
                    'modified_date': '20221109',
                    'license': 'all-rights-reserved',
                },
            },
            {
                'info_dict': {
                    ...
                    'track_number': 7,
                    'album_artists': ['Levi Ryan'],
                    'description': 'md5:53f9a5e65558519081deec213f29b64b',
                    'uploader': 'Levi Ryan',
                    'uploader_id': '229146182',
                    'uploader_url': 'https://soundcloud.com/leviryan',
                    'comment_count': int,
                    ...
                    'genres': ['Hip-hop & Rap'],
                    'track': 'richard',
                    'timestamp': 1667934443,
                    'upload_date': '20221108',
                    'modified_timestamp': 1667935728,
                    'modified_date': '20221108',
                    'license': 'all-rights-reserved',
                },
            },
            {
                'info_dict': {
                    'ext': 'm4a',
                    'title': 'close to you w/gravedweller',
                    'id': '1378971022',
                    'album': 'out of spite',
                    'album_type': 'album',
                    'track_number': 8,
                    'album_artists': ['Levi Ryan'],
                    'description': 'md5:c00763f631b9709745354e750eda42a5',
                    'uploader': 'Levi Ryan',
                    'uploader_id': '229146182',
                    'uploader_url': 'https://soundcloud.com/leviryan',
                    'comment_count': int,
                    ...
                    'track': 'close to you w/gravedweller',
                    'timestamp': 1667934138,
                    'upload_date': '20221108',
                    'modified_timestamp': 1667938729,
                    'modified_date': '20221108',
                    'license': 'all-rights-reserved',
                },
            },
        ...
        'playlist': [
            {
                'info_dict': {
                    'ext': 'm4a',
                    'title': 'TILT Brass Band improv - Sak Passé? (2003)',
                    'id': '83411137',
                    'album': 'TILT Brass - Bowery Poetry Club, August \'03 [Non-Site SCR 02]',
                    'album_type': 'playlist',
                    'track_number': 1,
                    'description': 'md5:2d97575eae7963177aa9e68943d6831e',
                    'uploader': 'Non-Site Records',
                    'uploader_id': '33660914',
                    'uploader_url': 'https://soundcloud.com/non-site_records',
                    'comment_count': int,
                    ...
                    'repost_count': int,
                    'duration': 121.946,
                    'thumbnail': 'https://i1.sndcdn.com/artworks-000043059968-sy1bg1-original.png',
                    'tags': ['Non-Site Records', 'TILT Brass', 'TILT Creative Brass Band', 'Bowery Poetry Club', 'large ensemble improv'],
                    'album_artists': ['Non-Site Records'],
                    'genres': ['Improvisation'],
                    'track': 'TILT Brass Band improv - Sak Passé? (2003)',
                    'timestamp': 1363375050,
                    'upload_date': '20130315',
                    'release_timestamp': 1363392000,
                    'release_date': '20130316',
                    'modified_timestamp': 1436238647,
                    'modified_date': '20150707',
                    'license': 'all-rights-reserved',
                },
            },
            {
                'info_dict': {
                    'ext': 'mp3',
                    'title': 'Nick Didkovsky - Pascal\'s Triangle (1992) [arr. G. Evans]',
                    'id': '83411280',
                    'album': 'TILT Brass - Bowery Poetry Club, August \'03 [Non-Site SCR 02]',
                    'album_type': 'playlist',
                    'track_number': 2,
                    'description': 'md5:5c15d69826cefa67cc515d71a02aff03',
                    'uploader': 'Non-Site Records',
                    'uploader_id': '33660914',
                    'uploader_url': 'https://soundcloud.com/non-site_records',
                    'comment_count': int,
                    ...
                    'repost_count': int,
                    'duration': 242.569,
                    'thumbnail': 'https://i1.sndcdn.com/artworks-000043059997-amygfb-original.png',
                    'tags': ['Non-Site Records', 'TILT Brass', 'TILT Creative Brass Band', 'Nick Didkovsky', 'Dave Ballou', 'Russ Johnson', 'Jon Nelson', 'Bowery Poetry Club'],
                    'album_artists': ['Non-Site Records'],
                    'genres': ['Contemporary Classical'],
                    'track': 'Nick Didkovsky - Pascal\'s Triangle (1992) [arr. G. Evans]',
                    'timestamp': 1363375126,
                    'upload_date': '20130315',
                    'release_timestamp': 1363392000,
                    'release_date': '20130316',
                    'modified_timestamp': 1436238647,
            ...
            },
            {
                'info_dict': {
                    'ext': 'mp3',
                    'title': 'Tom Waits - Coney Island Baby (2002) [arr. D. Ballou]',
                    'id': '83460399',
                    'album': 'TILT Brass - Bowery Poetry Club, August \'03 [Non-Site SCR 02]',
                    'album_type': 'playlist',
                    'track_number': 3,
                    'description': 'md5:97bb67d6283de22d970d8d06758f7be7',
                    'uploader': 'Non-Site Records',
                    'uploader_id': '33660914',
                    'uploader_url': 'https://soundcloud.com/non-site_records',
                    'comment_count': int,
                    ...
                    'repost_count': int,
                    'duration': 264.722,
                    'thumbnail': 'https://i1.sndcdn.com/artworks-000043060010-34hrpg-original.png',
                    'tags': ['Non-Site Records', 'TILT Brass', 'TILT Creative Brass Band', 'Bowery Poetry Club', 'Tom Waits', 'Dave Ballou'],
                    'album_artists': ['Non-Site Records'],
                    'genres': ['Downtown'],
                    'track': 'Tom Waits - Coney Island Baby (2002) [arr. D. Ballou]',
                    'timestamp': 1363401752,
                    'upload_date': '20130316',
                    'release_timestamp': 1363392000,
                    'release_date': '20130316',
                    'modified_timestamp': 1436238647,
            ...
            },
            {
                'info_dict': {
                    'ext': 'm4a',
                    'title': 'Tom Waits - Knife Chase (2002) [arr. D. Ballou]',
                    'id': '83460998',
                    'album': 'TILT Brass - Bowery Poetry Club, August \'03 [Non-Site SCR 02]',
                    'album_type': 'playlist',
                    'track_number': 4,
                    'description': 'md5:ded101867c57045058893c80f16806fa',
                    'uploader': 'Non-Site Records',
                    'uploader_id': '33660914',
                    'uploader_url': 'https://soundcloud.com/non-site_records',
                    'comment_count': int,
                    ...
                    'repost_count': int,
                    'duration': 155.902,
                    'thumbnail': 'https://i1.sndcdn.com/artworks-000043060045-t9n9a9-original.png',
                    'tags': ['Non-Site Records', 'TILT Brass', 'TILT Creative Brass Band', 'Bowery Poetry Club', 'Tom Waits', 'Dave Ballou'],
                    'album_artists': ['Non-Site Records'],
                    'genres': ['Downtown'],
                    'track': 'Tom Waits - Knife Chase (2002) [arr. D. Ballou]',
                    'timestamp': 1363402175,
                    'upload_date': '20130316',
                    'release_timestamp': 1363392000,
                    'release_date': '20130316',
                    'modified_timestamp': 1436238647,
            ...
            },
            {
                'info_dict': {
                    'ext': 'm4a',
                    'title': 'Elliott Sharp - SyndaKit (1998)',
                    'id': '83462427',
                    'album': 'TILT Brass - Bowery Poetry Club, August \'03 [Non-Site SCR 02]',
                    'album_type': 'playlist',
                    'track_number': 5,
                    'description': 'md5:6e45e3abc80e7ab975f82b8db32584a5',
                    'uploader': 'Non-Site Records',
                    'uploader_id': '33660914',
                    'uploader_url': 'https://soundcloud.com/non-site_records',
                    'comment_count': int,
                    ...
                    'repost_count': int,
                    'duration': 875.383,
                    'thumbnail': 'https://i1.sndcdn.com/artworks-000043060061-cf171z-original.png',
                    'tags': ['Non-Site Records', 'TILT Brass', 'TILT Creative Brass Band', 'Bowery Poetry Club', 'Elliott Sharp'],
                    'album_artists': ['Non-Site Records'],
                    'genres': ['Downtown'],
                    'track': 'Elliott Sharp - SyndaKit (1998)',
                    'timestamp': 1363403125,
                    'upload_date': '20130316',
                    'release_timestamp': 1363392000,
                    'release_date': '20130316',
                    'modified_timestamp': 1436238647,
            ...
            },
            {
                'info_dict': {
                    'ext': 'm4a',
                    'title': 'AFKA Prince - We March (1994) [arr. C. McIntyre]',
                    'id': '83463843',
                    'album': 'TILT Brass - Bowery Poetry Club, August \'03 [Non-Site SCR 02]',
                    'album_type': 'playlist',
                    'track_number': 6,
                    'description': 'md5:20ae2decc2f47e618161e05fb5319d8f',
                    'uploader': 'Non-Site Records',
                    'uploader_id': '33660914',
                    'uploader_url': 'https://soundcloud.com/non-site_records',
                    'comment_count': int,
                    ...
                    'repost_count': int,
                    'duration': 491.958,
                    'thumbnail': 'https://i1.sndcdn.com/artworks-000043059835-6if2m8-original.png',
                    'tags': ['Non-Site Records', 'TILT Brass', 'TILT Creative Brass Band', 'Bowery Poetry Club', 'Chris McIntyre', 'NPG', 'Kalakuta'],
                    'album_artists': ['Non-Site Records'],
                    'genres': ['Second Line Funk'],
                    'track': 'AFKA Prince - We March (1994) [arr. C. McIntyre]',
                    'timestamp': 1363404036,
                    'upload_date': '20130316',
                    'release_timestamp': 1363392000,
                    'release_date': '20130316',
                    'modified_timestamp': 1436238647,
